    ...
    <div className="mx-12 lg:mx-60 md:mx-42 dark:bg-black">
      ...
      <div className="pb-5">
        ...
        <Typography variant={"h2"}>
          ...
          videos in Europe and you can see them in the Media section. Enjoy this zenful animation.
        </Typography>
      </div>
      <Shape></Shape>
      ...
      {/* <div className="toggle-theme flex items-center justify-center" onclick="toggleDarkMode()"> */}
      <div className="toggle-theme flex items-center justify-center">
        <i className="fa-solid fa-lightbulb flex items-center"></i>
      </div>
